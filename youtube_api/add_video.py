...
"""
You can get help on all the command-line flags the program understands
by running:

  $ python add_video.py --help

To get detailed log output run:

  $ python add_video.py --logging_level=DEBUG
"""
...
def main(argv):
  ...
  try:
    ...
    response = service.playlistItems().insert(
       ...
       body=dict(
         snippet=dict(
           playlistId=FLAGS.playlist_id,
           resourceId=dict(
             videoId=FLAGS.video_id,
             kind="youtube#video",
           ),
         ),
       )
    ...
    print "HTTP Response: %s" % str(response)

    # For more information on the YouTube Data API API you can visit:
    #
    #   https://developers.google.com/youtube/v3
    #
    # For more information on the YouTube Data API API python library surface you
    # can visit:
    #
